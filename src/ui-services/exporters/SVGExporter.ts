...
import { DrawOptions } from '@genbs/urpflanze/dist/services/types/drawer-canvas'
import app_utilities from 'app_utilities'

class SVGExporter {
	static export(drawer: DrawerCanvas, settings: IRenderSettings): string {
		...
		result.push(`<!-- Generate with: ${app_utilities.app_name} ${app_utilities.app_version} -->`)
		result.push(
