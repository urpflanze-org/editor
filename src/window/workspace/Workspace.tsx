...
import Toolbar from '@window/workspace/toolbar/Toolbar'
import Drawer from '@window/workspace/drawer/Drawer'
import Timeline from '@window/workspace/timeline/Timeline'
import Layers from '@window/workspace/layers/Layers'
import Properties from '@window/workspace/properties/Properties'
