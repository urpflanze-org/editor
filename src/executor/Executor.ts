...
import { Scene } from '@urpflanze/core/dist/cjs/Scene'
import { Renderer, Emitter } from '@urpflanze/drawer-canvas/dist/cjs'
...
import { JSONExporter, UIDrawerCanvas } from 'urpflanze-ext'
...
class Executor extends Emitter<EventIterceptor> {
	 ...
	 * @memberof Executor
	 */
	public updateDrawer(drawer: UIDrawerCanvas): void {
		...
		this.drawer = new UIDrawerCanvas(
			drawer.getScene(),
			drawer.getCanvas() as HTMLCanvasElement,
			//@ts-ignore
